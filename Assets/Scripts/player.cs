...
public class player : MonoBehaviour
{
   ...
   [Header("Attack Head")]
    ...
    public void startFight()
    {
        ...
        //Debug.Log("Player, Start Fight Acc: " + accuracy); //EJ FEL DÅ DETTA SCRIPT EJ KÖRS VID UTFÖRANDE AV ATTACK
        //Strength
    ...
    public void updateStamina(int staminaChange)
    {
        ...
        //Om dodge är Active, minska stamina
        /*if (dodgeActive == true) //MINSKAR STAMINA ÄVEN OM DET ÄR SPELARENS TUR ATT ATTACKERA
        {
