...
public class simulateFight : MonoBehaviour
{
    ...
    public void Start()
   {
    ...
    public void endOfFight()
    {
        ...
        SimulateFightDataSO.fightStylePlayerOne.Add(PlayerOne.fightStyleNow.ToString());
        SimulateFightDataSO.fightStylePlayerTwo.Add(PlayerTwo.fightStyleNow.ToString());
